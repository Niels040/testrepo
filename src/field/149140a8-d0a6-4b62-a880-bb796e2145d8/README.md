...
<field
	...
	name="phonecode"
	label="Phone Code"
	description="Each country is assigned a unique three-digit code, which serves as the international dialing prefix added to all phone numbers within that country."
	class="text_area"
	message="Error! Please add phone code here."
	hint="+264"
/>
```
