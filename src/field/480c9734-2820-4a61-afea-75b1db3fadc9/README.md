...
<field
	...
	description="A human-readable label showing the GMT/UTC offset in hours and minutes."
	class="text_area"
	message="Error! Please add the GMT Offset name here."
	hint="UTC+02:00"
/>
```
