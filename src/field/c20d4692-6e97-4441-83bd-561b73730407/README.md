...
<field
	...
	description="Specifies the IANA timezone name representing the geographic region or city."
	class="text_area"
	message="Error! Please add the Timezone Identifier here."
	hint="Africa/Windhoek"
/>
```
