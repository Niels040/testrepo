...
<field
	...
	name="region"
	label="Region"
	sql_title_table="#__###component###_region"
	sql_title_column="name"
	sql_title_key="guid"
	urlSelect="index.php?option=com_###component###&amp;view=regions&amp;layout=modal&amp;tmpl=component&amp;titleKey=guid"
	urlNew="index.php?option=com_###component###&amp;task=region.add&amp;layout=modal&amp;tmpl=component"
	urlEdit="index.php?option=com_###component###&amp;task=region.edit&amp;guid={id}&amp;layout=modal&amp;tmpl=component&amp;titleKey=guid"
	titleSelect="Select A Region"
	titleNew="New Region"
	titleEdit="Edit the Region"
