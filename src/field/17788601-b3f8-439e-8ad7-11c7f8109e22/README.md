...
<field
	...
	description="Indicates the time difference from GMT/UTC in seconds. Negative means behind UTC."
	class="text_area"
	message="Error! Please add the GMT Offset in seconds here."
	hint="7200"
/>
```
