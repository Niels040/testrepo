### JCB! Custom Code
# php Configuration Check (call)

## JCB (manual)
```
[CUSTOMCODE=phpConfigurationCheckCall]
```

### Code
```php
			// Check that the PHP configurations are sufficient 
			if ($this->classExists(Super___4b2d6f28_346e_46ec_bf24_d470319cca2d___Power::class))
			{
				(new Super___4b2d6f28_346e_46ec_bf24_d470319cca2d___Power())->run();
			}
```
